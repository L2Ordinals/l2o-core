...
use crate::{standards::l2o_a::L2OBlockInscriptionV1, fields::goldilocks::hash::hash256_to_goldilocks_u32};
...
pub fn get_block_payload_goldilocks_hash_u32_mode(block: &L2OBlockInscriptionV1) -> Vec<GoldilocksField> {
  ...
  payload_bytes.extend_from_slice(&hash256_to_goldilocks_u32(&block.start_withdrawal_state_root));
